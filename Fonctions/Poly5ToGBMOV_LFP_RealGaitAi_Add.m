function [lfp_out] = Poly5ToGBMOV_LFP_RealGaitAi_Add(lfp_var, filename)
...
% and condition (auto-initiated trials)
...
for ii=1:length(trig)
    ...
    trialName = [protocole '_' session '_' subjectCode  '_' medCondition '_' speedCondition '_AI_' num2str(trialNum,'%02d')];
